    ...
    <ScrollView ref={scrollViewRef} showsVerticalScrollIndicator={false}>
        ...
        <View className="px-5">
          <View>
            <Text
              ...
              style={[styles.popsemi, { fontSize: 20 }]}
            >
              Trip / Tour Name :{" "}
              <Text style={[styles.popsemi, { color: "#888A83" }]}>
                {" "}
                {tripData.tripName}
              </Text>
            </Text>
      ...
      <View className="flex-1 px-2 bg-[#fafcff]">
        <View className="bg-[#fafcff] my-6">
          <Text style={[styles.popsemi, { fontSize: 18 }]} className="mb-6">
            Travel-to tickets :{" "}
          </Text>
        ...
        <Pressable
          ...
          onPressOut={GenerateReport}
          className="mb-10"
        >
          <View className="items-end my-5 mt-6 mr-3">
            <View
              className="flex flex-row gap-x-2 items-center justify-center h-12 w-48 rounded-2xl border-[0.2px] bg-white"

    ...
    try {
      ...
      if (document.type !== "cancel") {
        ...
        if (!response.ok) {
          ...
          Alert.alert(
            "Error while uploading the image , please do try with compressed version of the image"
          );
  ...
  return (
    <ScrollView className="flex-1 h-full bg-[#fafcff] ">
      <View className="flex-1 px-2 bg-[#fafcff] py-9">
        <View className="px-5">
          <View className="">
            <Text style={[styles.popsemi, { fontSize: 18 }]}>
              Travel-to tickets :{" "}
            </Text>
            ...
            <Pressable onPress={pickDocument1}>
              ...
              >
                ...
                >
                  ...
                  <Text className="items-center" style={styles.popreg}>
                    (Max. File size: 10 MB)
                  </Text>
                </View>
              </View>
              ...
              {pickedDocumentName1 && (
                <View className="flex flex-row items-center  justify-center ">
                  ...
                  <View className="w-40 h-5">
                    <Text className=" overflow-x-scroll" style={styles.popreg}>
                      {pickedDocumentName1}
                    </Text>
                  </View>
                  <Image
            ...
            <Pressable onPress={pickDocument2}>
              ...
              >
                ...
                >
                  ...
                  <View className="flex flex-row mt-2">
                    <Text style={styles.popreg}>Click to Upload</Text>
                    <Text style={styles.popreg}>
                      {" "}
                      or drag and drop only ( .pdf )
                    </Text>
                  </View>
                  <Text className="items-center" style={styles.popreg}>
                    (Max. File size: 10 MB)
            ...
            <View className="h-14 bg-white border border-[#CACACA] rounded-lg mt-4  justify-center ">
              {pickedDocumentName2 && (
                <View className="flex flex-row items-center  justify-center ">
                  ...
                  />
                  <View className="w-40 h-5">
                    <Text className="" style={styles.popreg}>
                      {pickedDocumentName2}
                    </Text>
                  </View>
            ...
            <View className="items-end my-5 mt-6 mr-3">
              ...
              >
                <View>
                  <Text
                    className="text-base"
                    style={[styles.popsemi, isPressed && styles.text]}
                  >
                    Preview >>
                  </Text>
                </View>
